...
export const ChapterVideoForm = ({
  ...
  const onSubmit = async (values: z.infer<typeof formSchema>) => {
    try {
      ...
      toggleEdit();
      //router.refresh();
      //по долу написаното е използваме техника, така че видеото като се уподне да се рефрешна на база URL, иначе с router.refresh(); не се показва видеото веднага а трябва да рефрешнем.  
